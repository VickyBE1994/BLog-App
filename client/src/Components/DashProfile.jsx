...
import { Alert, Button, ButtonGroup, Modal, TextInput } from 'flowbite-react'
...
const uploadImage=async()=>{
    ...
    uploadTask.on (
        ...
        (error)=> {
            setImageFileUploadError('Could not upload image (File less than 2MB')
            ...
            <HiOutlineExclamationCircle className='h-14 w-14 text-gray-400
             dark:text-gray-200 mb-4 mx-auto'/>
                <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>
                    Are you sure want delete your account?</h3>
